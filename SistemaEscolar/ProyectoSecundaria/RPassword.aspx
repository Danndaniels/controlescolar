<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RPassword.aspx.cs" Inherits="RPassword" %>
...
<div class="layout-theme animated-css"  data-header="sticky" data-header-top="200"> 
  ...
  <div id="wrapper"> 
    ...
    <div class="wrap-title-page">
      <div class="container">
        <div class="row">
          <div class="col-xs-12">
            <h1 class="ui-title-page">Recuperación de contraseña</h1>

              <h3 class="ui-title-b">Para recuperar tu contraseña deberas ingresar tu nombre de usuario y el correo con el cual fuiste dado de alta</h3>
      ...
      <div class="container">
							<div class="row">
								<div class="col-sm-12">
                                    	...
                                    	<h2 class="ui-title-block">Se enviara a tu correo una contraseña provicional, <strong>al ingresar al sistema deberas cambiarla por tu seguridad</strong></h2>
  ...
  <tr>
    <td><h2>Ingrese el usuario</h2></td>
    <td>
